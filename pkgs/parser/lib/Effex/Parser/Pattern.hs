module Effex.Parser.Pattern where
...
import Effex.Parser.Common (HasAnn, Parser, SourceSpan (..), pIdentifier, sepEndBy1, single)
import Effex.Parser.Literal (literal)
import Effex.Parser.Type (pBindersWoConstraints, pQualifiedIdentifier)
